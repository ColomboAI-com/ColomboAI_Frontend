...
export default function SocialAuthentication() {
  ...
  return (
    <div className="sm:flex sm:items-center sm:justify-center sm:gap-[16px]">
      <div className='flex align-middle bg-opacity-45 rounded-full border-[1px] border-brandprimary sm:bg-[#E2F2FF] p-3 xl:px-[24px] mb-[15px]' onClick={continueWithGoogle}>
        {
      ...
      <div className='flex align-middle bg-opacity-45 rounded-full border-[1px] border-brandprimary sm:bg-[#E2F2FF] p-3 2xl:px-[24px] xl:px-[24px] mb-[15px]' onClick={continueWithMeta}>
        {
      ...
      <div className='flex align-middle bg-opacity-45 rounded-full border-[1px] border-brandprimary sm:bg-[#E2F2FF] p-3 2xl:px-[24px] xl:px-[24px] mb-[15px]' onClick={continueWithMicrosoft}>
        {

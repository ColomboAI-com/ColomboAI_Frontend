...
const Chat = ({ loading, messages, sendMessage, chatId, query, sources, displaysource }) => {
  ...
  return (
    <div style={{ position: "relative" }} className={`${font.className} wider-scrollbar overflow-y-scroll max-h-[31rem] flex flex-row w-full md:gap-[0rem] lg:gap-[2rem] xl:gap-[8rem]`}>
      {messages.length > 0 && (
        <div
          style={chatContainerStyle}
          className="md:ml-[2.4rem] lg:ml-[7rem] flex flex-col md:items-start xl:items-center"

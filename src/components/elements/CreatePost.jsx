  ...
  return (
    <>
      <div className="border-[1px] border-brandprimary rounded-[10px] min-h-[82vh] no-scrollbar overflow-y-auto  font-sans">
        ...
        <div className=" px-10 font-sans flex flex-col justify-between h-[80vh] ">
          <div
            className={`flex flex-col  ${isMagicPenOpen ? "mt-10 gap-5" : ""}`}
          >
            <div
            ...
            >
              <div className="flex items-start w-full">
                ...
                />
                <button className=" -ml-12 mt-3 ">
                  <SendIcon w={32} h={32} fill={"#1E71F2"} />
                </button>
              </div>
              {!nextStep && (
                <button
                  onClick={() => setNextStep(true)}
                  className=" text-brandprimary font-semibold mx-1"
                >
                  Next
                </button>
              )}

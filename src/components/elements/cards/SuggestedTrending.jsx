...
const SuggestedTrending = () => {
    return (
        ...
        <div className="relative sm:w-[4rem] md:w-[8rem] mt-2 border-[0.25px] border-brandprimary rounded-[0.96rem] shadow-[1px_1px_2px_0px_#0000004D">
...
export default SuggestedTrending;
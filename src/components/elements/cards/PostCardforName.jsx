...
const PostCardforName = ({ post , CreatorName}) => {
  ...
  return (
    <>
      ...
      {console.log(post.creator.name.replace(/[^a-zA-Z0-9]/g, ''), CreatorName)}
      { post.creator.name.replace(/[^a-zA-Z0-9]/g, '') == CreatorName.replace(/[^a-zA-Z0-9]/g, '') ?
...
export default PostCardforName;

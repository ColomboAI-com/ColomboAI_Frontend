...
import PostCardforName from "./PostCardforName";
import RePostCard from "./RePostCard";

const PostforName = ({ post, index, CreatorName}) => {
  ...
  return (
    <>
      {!(post.repostBy) ? <PostCardforName post={post} CreatorName={CreatorName}/> : <RePostCard post={post}/> }

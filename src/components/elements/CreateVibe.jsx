...
const CreateVibe = ({
  ...
  return (
    <main className={plusJakartaSans.className}>
      ...
      {!isSelectedFromComputer ? (
        <div className="border-[1px] border-brandprimary rounded-[10px] min-h-[52vh] no-scrollbar overflow-y-auto">
          ...
          <div className="relative h-[32rem]">
            ...
            {isTrimming ? (
              ...
              <Button
                title={"NEXT"}
                className={
                  "absolute bottom-4 left-1/2 -translate-x-1/2 w-fit sm:text-xs font-[500] text-blue-500 shadow-[5px_5px_10px_0px_rgba(0,0,0,0.3)] rounded-full bg-white py-2 px-24 z-10"
                }

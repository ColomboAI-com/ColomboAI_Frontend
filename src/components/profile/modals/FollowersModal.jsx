...
const FollowersModal = ({ followersData }) => {
  const { setIsFollowerModalOpen, handleFollower } =
          ...
          return (
            <div key={person._id}>
              ...
              >
                ...
                <button
                  onClick={() => handleFollower(person)}
                  className={`${
                    person.is_following
                      ? "text-white bg-brandprimary"
                      : "text-brandprimary"
                  } border-[1px] border-brandprimary text-brandprimary rounded-2xl px-6 py-1`}
                >

      ...
      {!shareProfile && (
        <div className="w-full flex flex-col bg-[#1E71F2]">
          ...
          <div className=" flex flex-col items-center px-12 pb-10 gap-6">
            ...
            <button className="flex w-full justify-center items-center bg-white py-4 gap-4 rounded-2xl " onClick={handleShareProfile}>
      ...
      {shareProfile && (
        <div className="w-full flex flex-col items-center bg-[#1E71F2]">
          <div className="before:content-[''] before:bg-white before:block before:w-[40px] before:h-[3px] before:mx-auto before:rounded-[20px] before:mt-[8.98px]">
            <div className="flex">
              <h5 className="text-[18.51px] font-sans text-white text-center m-2">Share Profiles</h5>
              <button
          ...
          <div className="flex m-3 p-3 items-center flex-wrap gap-y-[9px] gap-[7.95px] px-[12px]">
            <Link href={`https://www.instagram.com/?url=${encodeURIComponent(profileUrl)}`} target="_blank">

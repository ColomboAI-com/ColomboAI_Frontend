    ...
    <div className="w-full flex flex-col items-center bg-white border-[#E3E3E3] sm2:w-[430px] md:w-[430px] z-50 rounded-t-[20px] sm2:rounded-[20px] md:rounded-[20px] px-[14px] pt-[40px] pb-[29px]">
      <div className="">
        <div className="w-[110px] mx-auto rounded-[50%]">
          <ProfilePicture size={110} image={`${unFollowModalData?.profile_picture}`} />
        </div>
        <div className="mt-[29px]">
          <p className="font-sans text-[#515151] text-[22.29px] font-[450] leading-[25.57px] text-center">Unfollow
            <span className="font-[700]">@{unFollowModalData?.name}</span>?</p>
        </div>
        <div>
          <Button
            title={'UNFOLLOW'}

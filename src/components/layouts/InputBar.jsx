        ...
        <form onSubmit={handleSubmit} className="lg:pb-[21px] sm:pb-0 pt-[21px] flex flex-row w-full items-center justify-center">
          ...
          >
            <textarea
              ...
              onChange={(e) => setMessage(e.target.value)}
              placeholder="Ask or create anything..."
              className="w-full sm:max-w-[17rem] nsm:max-w-[33rem] md:max-w-[31rem] lg:max-w-[34rem] xl:max-w-[45rem] text-wrap h-full pt-[0.8rem] resize-none px-[35px] text-[#1E71F2] text-[16px] tracking-[0.1rem] font-sans overflow-hidden text-ellipsis bg-transparent focus:outline-none"
            />
            <div className="absolute top-0 right-0 h-full flex items-center pr-[25px]">
              <button
                type="button"

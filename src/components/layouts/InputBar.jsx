        ...
        <form onSubmit={handleSubmit} className="lg:pb-[21px] sm:pb-0 pt-[21px] flex flex-row w-full justify-center">
          ...
          >
            <input
              ...
              placeholder="Ask or create anything..."
              className="w-full sm:max-w-[18rem] nsm:max-w-[33rem] md:max-w-[45rem] sm: h-full py-[17px] px-[35px]  text-[#1E71F2] text-[16px] tracking-[0.1rem] font-sans overflow-hidden text-ellipsis whitespace-nowrap bg-transparent focus:outline-none"
            />
            <div className="absolute top-0 right-0 h-full flex items-center pr-[25px]">
              <button
                type="button"

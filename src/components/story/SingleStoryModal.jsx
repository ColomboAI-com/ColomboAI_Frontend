...
//       {/* Middle Section */}
//       <div className="relative  m-auto">
//         {/* Center the story container both vertically and horizontally */}
//         <div className="h-3/4 w-full rounded-[5px] flex flex-col items-center justify-center story-detail-box">
//           <Stories
//             stories={data.map((story) => story.media)}
//             defaultInterval={5000}
//             width={432}
//             height={768}
//             //justifyContent={"center"}  // Not needed anymore
//             ref={storiesRef}
//             onAllStoriesEnd={handleAllStoriesEnd}
//             storyStyles={storyStyles}
//           />

...
export default function ShareVibe(currentState){
...
<img src="https://s3-alpha-sig.figma.com/img/27df/6da0/aff737baa08e22da524c95a696eb69f6?Expires=1726444800&Key-Pair-Id=APKAQ4GOSFWCVNEHN3O4&Signature=au2K9bd-IAmicVwx4fOqbww3VL~EXh5M6Id9judedoYTR6YIymQ-iWt2ugYBrpqdKjGWeq2fNppZzL~~s4u-4PxrcaA1wtMud1nJxSaLNbHyf-~Jq-IjQyL0OXitLHUx2LBv6bNIOFMp-UcgeS-VhKU18MlQRV6HNQaF1-T8~d9jOrcI~ZJRkhnBqm67L9B7EsHZnQLgP62EwDjY4tT2gqVJgx51xpsowkPec0WmK97SqQD5gX6TRzUDC9h3bHRMWVgneBZ7sxnHqM7U4JqNlFfa1YFTkhNSxXZRXWG4PvyYd13IbY3KHV5VJDj2LGhO5hoxCoKizIBBf76CSN0fkA__" alt="Anna XS" className="h-full w-full rounded-[50%]" />
                ...
                <div className="w-[56px] h-[76px] text-[12px]">
                <div className="bg-white h-[56px] w-[56px] rounded-[50%]">
                <img src="https://s3-alpha-sig.figma.com/img/6ebe/9b36/cc79e6880ce26ce0e7a1c2f0ca6dad68?Expires=1726444800&Key-Pair-Id=APKAQ4GOSFWCVNEHN3O4&Signature=gUJQyf0aTuiiM~afN6~9U-wKh~crTdJZPlis4zGy1B0NCyJcCShqai2PkbqVDxYixNZKP8-HJnG2VGE0XZGlVLfoq41ydKdu05OFLGN~uzHXgdLYkooiLqQqat4Pb7-KuUvlzbXj6hpARWZEUktPbkpZ~rLuqus37kfxCiLACwlfBZYK225tbuxe6ZWNhriC9QojYVN3g7Lxyvfx5uhEh0K76bJRIpPRVnmGL5TeOGSMT55JnyA693cTYoEnK4M-SEqYYM5wRZJX1qYO4aKV4riHwGrEaMfZ7CI09m80IGJPXwzQlDn6IbWueAwiGVD1wATzpGMl-PkNGi~6xCQiYg__" alt="Anna XV" className="h-full w-full rounded-[50%]" />
                </div>
                <div className="flex justify-center">
                Anna XV
                </div>
            ...
            <div className=" w-[56px] h-[74px] text-[12px] mb-[9px]">
                ...
                <div className="w-[56px] h-[74px] text-[12px] mb-[9px]">
                <div className="h-[56px] w-[56px] rounded-[50%] flex items-center justify-center" style={{ background: 'linear-gradient(0deg, #78CD51 7.27%, #A0FC84 107.27%)' }}>
                  <WhatsAppIcon/>
                </div>
                <div className="flex justify-center">
                WhatsApp
                ...
                <div className="w-[56px] h-[74px] text-[12px]">
                <div className="bg-white h-[56px] w-[56px] rounded-[50%] flex items-center justify-center" style={{background: `linear-gradient(0deg, #1D93D2 0%, #38B0E3 100%)`
}}>
                  <TelegramIcon/>
            ...
            <div className="flex justify-between mt-[14px] w-[400px] h-[30px] mx-auto">
              <button className="w-[78%] bg-white text-[#1E71F2] text-[12px] rounded-2xl w-[314px] h-[30px]" onClick={() => copyToClipboard('https://post.colomboai.com/660ad7b3053e33a40c....')}>
              https://post.colomboai.com/660ad7b3053e33a40c....
              
              </button>
              <button onClick={() => copyToClipboard('https://post.colomboai.com/660ad7b3053e33a40c....')} className="w-[20%] bg-white text-[14px] text-[#1E71F2] rounded-2xl w-[80px] h-[30px]">
                Copy
                </button>
            </div>

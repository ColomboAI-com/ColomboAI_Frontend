...
const Feed = () => {
    return (
        <div className="flex">
            <div className="w-[70%] pl-[86px] pr-[118px]">
                ...
                <div className="mb-8">
                    <Slider {...settings}>
                        <div className="bg-[url('/images/home/create-story.svg')] relative h-[240px] !w-[145px] bg-no-repeat bg-center border-[0.25px] border-brandprimary rounded-[10px] shadow-[1px_1px_2px_0px_#0000004D]">
                            <div className="h-full rounded-[10px] bg-gradient-to-t from-[#000000cf] to-[#00000000]"></div>
                            <div className="absolute bottom-14 px-6">
                                <div className="w-[42px] h-[42px] border-[1px] border-brandprimary rounded-full mx-auto">
                                    <img src="/images/home/add-new-story.svg" />
                                </div>
                                <h6 className="text-[16px] font-[450px] font-sans text-white text-center relative top-9">Create New Story</h6>
                            </div>
                        </div>
                        <div className="bg-[url('/images/home/story-img.png')] relative h-[240px] !w-[145px] bg-no-repeat bg-center border-[0.25px] border-brandprimary rounded-[10px] shadow-[1px_1px_2px_0px_#0000004D]">
                            <div className="h-full rounded-[10px] bg-gradient-to-t from-[#000000cf] to-[#00000000]"></div>
                            <div className="absolute bottom-5 px-8">
                                <div className="w-[42px] h-[42px] border-[1px] border-brandprimary rounded-full mx-auto">
                                    <img src="/images/home/story-profile-img.png" />
                                </div>
                                <h6 className="text-[16px] font-[450px] font-sans text-white text-center">@Anna_xvz</h6>
                            </div>
                        </div>
                        <div className="bg-[url('/images/home/story-img.png')] relative h-[240px] !w-[145px] bg-no-repeat bg-center border-[0.25px] border-brandprimary rounded-[10px] shadow-[1px_1px_2px_0px_#0000004D]">
                            <div className="h-full rounded-[10px] bg-gradient-to-t from-[#000000cf] to-[#00000000]"></div>

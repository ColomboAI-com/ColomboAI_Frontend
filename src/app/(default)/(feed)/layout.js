  ...
  return (
    <UserProfileContextProvider>
      {/* <div className="border-green-500 flex flex-row justify-center"> */}
        ...
        <FeedFilter className="bg-white w-full sticky top-0 z-10 sm:pb-[6px] sm:pt-[8px] lg:pb-[14px] lg:pt-[14px] sm2:py-3 flex flex-wrap items-center justify-evenly xl:px-6 lg:px-0 lg:gap-8 xl:gap-6 shadow-[0px_2px_4px_0px_#0000001A]" />
        </div>

  ...
  return (
    <UserProfileContextProvider>
      <div className="w-full mx-auto bg-white">
        ...
        <div className={`w-full overflow-x-clip hide-scrollbar ${pathname === "/explore" ? `overflow-y-visible` : `overflow-y-auto`} ${pathname === `/vibes` ? `md:px-0` : `md:px-10`} lg:px-0 ${pathname !== '/vibes' && `xl:px-20`}`} id="feed_section">
          {children}
        </div>
      </div>
    </UserProfileContextProvider>

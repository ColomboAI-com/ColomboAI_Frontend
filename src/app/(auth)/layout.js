    ...
    <AuthContextProvider>
      <SocialAuthContextProvider>
        ...
        <div className="2xl:hidden xl:hidden h-screen font-sans sm:block md:block lg:hidden">
          <div className="bg-[url('/images/auth/mobile-verification.png')] bg-no-repeat bg-[length:100%_100%] bg-top sm:h-[322px] md:h-[450px] flex items-center justify-center">
            <div >

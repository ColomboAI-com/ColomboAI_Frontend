  ...
  return (
    <div className="flex flex-col min-h-screen">
      <header className="sticky top-0 z-50 bg-white shadow-md">
        <div className="border-b-2 border-purple-50 py-2">
          {/* <img src="/images/home/ColomboAI-logo.svg" alt="ColomboAI Logo" className="mx-auto w-[183px]" /> */}
        </div>
        <RightSideIcons />
      </header>
...
// import Chat from '../../components/MassageInputActions/Chat';

...
//       // await addnewdevice(inputs.email); // Add new device after sign-in
//       // setShowPopup(true); // Show the popup after the new device is added
//       // }
...
//       // console.log("Calling addnewdevice...");
//       // await addnewdevice(inputs.email); // Add new device after sign-in
//       // console.log("addnewdevice should have been called.");

//       // setShowPopup(true); // Show the popup after the new device is added
//       // console.log("Popup should be set to show.");
...
export const AuthContextProvider = ({ children }) => {
  ...
  const signIn = async () => {
    try {
      ...
      // if (res.data.new_device) {
      setNew_device(true);
      setShowPopup(true); // Show the popup after the new device is detected
      // }

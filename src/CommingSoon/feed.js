    ...
    <div>
      ...
      <div style={cardStyle}>
        <p style={cardTextStyle}>
          Hang tight! Your personalized feed is still on its way. 🚀 We’re working
          to bring you all the content you love.
        </p>
        <p style={subTextStyle}>Stay tuned for the perfect scroll!</p>
      </div>
      {/* Coming Soon Section */}
